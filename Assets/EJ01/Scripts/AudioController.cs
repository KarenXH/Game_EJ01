...
public class AudioController : Singleton<AudioController>
{
    ...
    {
        if (PlayerPrefs.GetString("music") == "" || PlayerPrefs.GetString("music") == null) return;

        if (PlayerPrefs.GetString("music") == "on") musicAus.volume = 1;
        if (PlayerPrefs.GetString("music") == "off") musicAus.volume = 0;
    }

    public void OnOffSfx()
    {
        if (PlayerPrefs.GetString("sfx") == "" || PlayerPrefs.GetString("sfx") == null) return;

        if (PlayerPrefs.GetString("sfx") == "on") sfxAus.volume = 1;
        if (PlayerPrefs.GetString("sfx") == "off") sfxAus.volume = 0;
    }
